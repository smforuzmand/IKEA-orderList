...
function App() {
  ...
  return (
    <div className="todo-app">
      ...
      <p className="message">welcome to IKEA's shopping list. Here you will be able to create a todo list for the furniture you want to purchase.
        To get started press the Add new item button and a popup will ask you the name and the price of the item you want to add. You can also add an image after the item is added by touching the camera Icon</p>
      <br></br>
